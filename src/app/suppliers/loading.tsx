export default function LoadingSuppliersList() {
  return (
        ...
        <div className="divide-y" style={{ borderColor: "var(--border)" }}>
          {[1, 2, 3, 4, 5].map((i) => (
            <div key={i} className="p-4 flex items-center justify-between gap-4">
              ...
              <div className="h-4 w-48 rounded hidden sm:block" style={{ background: "var(--surface-raised)" }} />
              <div className="h-4 w-24 rounded hidden md:block" style={{ background: "var(--surface-raised)" }} />
              <div className="h-4 w-12 rounded hidden md:block" style={{ background: "var(--surface-raised)" }} />
              <div className="h-4 w-10 rounded" style={{ background: "var(--surface-raised)" }} />
            </div>
          ))}
        </div>
      </div>
